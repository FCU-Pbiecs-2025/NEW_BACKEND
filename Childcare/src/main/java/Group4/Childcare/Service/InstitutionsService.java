...
public class InstitutionsService {
   ...
   */
  public Institutions createWithImage(Institutions entity, MultipartFile imageFile) throws IOException {
    // 先儲存機構資料以取得 ID
    Institutions saved = repository.save(entity);

    // 如果有上傳圖片，則儲存並更新 imagePath
    if (imageFile != null && !imageFile.isEmpty()) {
      String imagePath = fileService.saveInstitutionImage(imageFile, saved.getInstitutionID());
